...
SIMPLIFIED ICE SERVERS FOR CLEAN AUDIO (WhatsApp Style)
"""
import os
...
# ==================== 🔐 WEBRTC & TURN CONFIGURATION (SIMPLIFIED!) ====================
...
METERED_API_KEY = os.getenv('METERED_API_KEY', 'e55ae0cfbf5bc4d8ae1e5e9f')
METERED_SECRET_KEY = os.getenv('METERED_SECRET_KEY', 'p2OsvDBxN+xEr3rY8YGxGp9yX5hUJQDlq5NZW3C3rUw=')

# OpenRelay TURN Credentials (Backup - not used in simplified mode)
...
def get_ice_servers():
    """
    Get SIMPLIFIED ICE servers configuration for WebRTC
    WhatsApp Style: 1 STUN + 1 TURN = Clean Audio!
    """
    ice_servers = [
        # ✅ ONE STUN SERVER (Google - Most reliable)
        {
            'urls': 'stun:stun.l.google.com:19302'
        },
        
        # ✅ ONE TURN SERVER (Metered.ca - Best quality, 4 endpoints)
        {
...
def get_webrtc_config():
    """Get complete WebRTC configuration dictionary with ECHO CANCELLATION"""
    return {
...
def print_config_summary():
    ...
    print("\n" + "="*70)
    print(" 🚀 CA360 CHAT - CONFIGURATION SUMMARY (SIMPLIFIED AUDIO)")
    print("="*70)
    ...
    print("\n" + "-"*70)
    print(" 📞 WebRTC & Calling Configuration (WhatsApp Style)")
    print("-"*70)
    ...
    print(f"📡 STUN Servers: 1 (Google)")
    print(f"🔄 TURN Servers: 1 (Metered.ca - 4 endpoints)")
